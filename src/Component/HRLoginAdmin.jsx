    ...
    <div className="flex flex-col h-screen">
      ...
      <div className="flex flex-grow">
        ...
        <div className="flex justify-center items-center w-1/2 bg-left">
          <img src="image.svg" alt="Background Image" className="mt-6 ml-0" style={{ width: "800px", height: "750px", marginTop: "10px" }} />
        </div>
        ...
        <div className="flex flex-col justify-between items-center w-1/2 bg-white" style={{ marginTop: "4px" }}>
          <div className="relative" style={{ marginTop: '3px' }}> {/* Adjusted margin-top */}
            ...
            <div className="bg-blue-800 mt-7 rounded-2xl flex flex-col items-center" style={{ width: "600px", height: "550px" }}>
              ...
              <div className="relative mt-10" style={{ width: "400px", height: "50px", padding: "10px 0px 0px 0px", gap: "10px", borderRadius: "20px 0px 0px 0px", opacity: "0px" }}>
                <input
                  type="text"
                  className="w-full h-full px-4 rounded-tl-xl rounded-xl bg-white"
                  placeholder="Company Name..."
                  
                />
                <input
                  type="password"
                  className="w-full h-full mt-[15px] px-4 rounded-tl-xl rounded-xl bg-white"
              ...
              <button className="w-117 h-61 px-4 rounded-tl-xl rounded-xl bg-white mt-6" style={{ marginTop: '80px', fontFamily: 'Roboto Serif', fontSize: '35px', fontWeight: '400', lineHeight: '40.99px', textAlign: 'center' }}>Login</button>
            </div>
          </div>
