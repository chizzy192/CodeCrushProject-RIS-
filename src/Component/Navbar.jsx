      ...
      <div className=" items-start ">
        ...
        <div className="menu" onClick={() => {setMenuOpen(!menuOpen);}}>
          ...
          <ul className="flex flexbox flex-row flex-wrap text-center w-auto ">
            <li className="text-white py-2 sm:text-lg hover:underline active:bg-white active:text-black rounded-lg active:no-underline "><NavLink to="/">Home</NavLink></li>
            <li className="text-white py-2 sm:text-lg hover:underline active:bg-white active:text-black rounded-lg active:no-underline "><NavLink to="/about">About</NavLink></li>
            <li className="text-white py-2 sm:text-lg hover:underline active:bg-white active:text-black rounded-lg active:no-underline"><NavLink to="/resources">Resources</NavLink></li>
            <li className="text-white py-2 sm:text-lg hover:underline active:bg-white active:text-black rounded-lg active:no-underline"><NavLink to="/contact">Contact Us</NavLink></li>
